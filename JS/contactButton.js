...
firstPlatform.addEventListener('click',()=>{
    window.open("https://www.instagram.com/raj_k_25123/");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:rajesh.iiitian25@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/rajeshkrack");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/rajesh-kumbhakarn-6487aa228/");
});